...
liberal_dem_model <- readRDS(paste0(path, "liberal_dem.rds"))
...
census_data_1 <-
  ...
  summarise(
    ...
    .by = c(const_c, country, region, age_bracket, educ_level, female, count)
  )
...
census_data_1 <-
  ...
  summarise(
    ...
    .by = c(
      const_c, country, region, age_bracket,
